...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the evos_project metadata
        ...
        # The PEP 517 backend we should use to build the evos_project
    ...
    def warn_on_mismatching_name(self):
        ...
        logger.warning(
            ...
            'produced metadata for evos_project name %s. Fix your '
            '#egg=%s fragments.',
    ...
    def prepare_metadata(self):
        # type: () -> None
        """Ensure that evos_project metadata is available.
