...
class CollectedLinks(object):
    ...
    The return value includes both URLs to evos_project pages containing package
    ...
    (3) urls to HTML evos_project pages, as described by the PEP 503 simple
        repository API.
    """
    ...
    def __init__(
        ...
        :param project_urls: URLs to HTML evos_project pages, as described by
...
class LinkCollector(object):
    ...
    def collect_links(self, project_name):
        ...
        """Find all available links for the given evos_project name.
